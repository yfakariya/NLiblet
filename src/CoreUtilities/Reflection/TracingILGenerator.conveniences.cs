...
namespace NLiblet.Reflection
{
	partial class TracingILGenerator
	{
		...
		{
			Contract.Requires<ArgumentNullException>( formatLiteral != null );
			Contract.Requires<ArgumentException>( 0 < formatLiteral.Length );
			Contract.Requires<ArgumentNullException>( argumentLoadingEmitters != null );
			Contract.Requires<ArgumentException>( Contract.ForAll( argumentLoadingEmitters, item => item != null ) );
		...
		public void EmitStringFormat( int temporaryLocalArrayIndex, Type resource, string resourceKey, params Action<TracingILGenerator>[] argumentLoadingEmitters )
		{
			...
			Contract.Requires<ArgumentNullException>( resourceKey != null );
			Contract.Requires<ArgumentException>( !String.IsNullOrWhiteSpace( resourceKey ) );
			Contract.Requires<ArgumentNullException>( argumentLoadingEmitters != null );
			Contract.Requires<ArgumentException>( Contract.ForAll( argumentLoadingEmitters, item => item != null ) );
		...
		{
			Contract.Requires<ArgumentOutOfRangeException>( 0 <= argumentIndex && argumentIndex <= UInt16.MaxValue );
		...
		{
			Contract.Requires<ArgumentOutOfRangeException>( 0 <= localIndex && localIndex <= UInt16.MaxValue );
		...
		{
			Contract.Requires<ArgumentOutOfRangeException>( 0 <= arrayLocalIndex );
			Contract.Requires<ArgumentNullException>( elementType != null );
			Contract.Requires<ArgumentNullException>( elementLoadingEmitters != null );
			Contract.Requires<ArgumentException>( Contract.ForAll( elementLoadingEmitters, item => item != null ) );
		...
		{
			Contract.Requires<ArgumentNullException>( arrayLoadingEmitter != null );
			Contract.Requires<ArgumentNullException>( arrayStoringEmitter != null );
			Contract.Requires<ArgumentNullException>( elementType != null );
			Contract.Requires<ArgumentNullException>( elementLoadingEmitters != null );
			Contract.Requires<ArgumentException>( Contract.ForAll( elementLoadingEmitters, item => item != null ) );
		...
		public void EmitAnyStelem( Type elementType, Action<TracingILGenerator> arrayLoadingEmitter, long index, Action<TracingILGenerator> elementLoadingEmitter )
		{
			...
			Contract.Requires<ArgumentOutOfRangeException>( 0 <= index );
			Contract.Requires<ArgumentNullException>( arrayLoadingEmitter != null );
			Contract.Requires<ArgumentNullException>( elementLoadingEmitter != null );
