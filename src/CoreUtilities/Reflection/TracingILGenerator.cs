...
namespace NLiblet.Reflection
{
	...
	public sealed partial class TracingILGenerator
	{
		...
		{
			Contract.Requires<ArgumentNullException>( methodBuilder != null );
		}
		...
		{
			Contract.Requires<ArgumentNullException>( dynamicMethod != null );
		}
		...
		{
			Contract.Requires<InvalidOperationException>( !this.IsEnded );
			Contract.Requires<ArgumentNullException>( localType != null );
		...
		public LocalBuilder DeclareLocal( Type localType, string name )
		{
			...
			Contract.Requires<ArgumentException>( ILAssemblyLanguage.IsValidId( name ) );
			Contract.Ensures( Contract.Result<LocalBuilder>() != null );
		...
		{
			Contract.Requires<InvalidOperationException>( !this.IsEnded );
			Contract.Requires<ArgumentNullException>( tryBlockEmitter != null );
			Contract.Requires<ArgumentNullException>( firstCatchBlock != null );
			Contract.Requires<ArgumentException>( firstCatchBlock.Item1 != null && firstCatchBlock.Item2 != null );
			Contract.Requires<ArgumentNullException>( remainingCatchBlockEmitters != null );
			Contract.Requires<ArgumentException>( Contract.ForAll( remainingCatchBlockEmitters, item => item != null && item.Item1 != null && item.Item2 != null ) );
		...
		)
		{
			Contract.Requires<InvalidOperationException>( !this.IsEnded );
			Contract.Requires<ArgumentNullException>( tryBlockEmitter != null );
			Contract.Requires<ArgumentNullException>( finallyBlockEmitter != null );
			Contract.Requires<ArgumentNullException>( catchBlockEmitters != null );
			Contract.Requires<ArgumentException>( Contract.ForAll( catchBlockEmitters, item => item != null && item.Item1 != null && item.Item2 != null ) );
		...
		public void BeginCatchBlock( Type exceptionType )
		{
			...
			Contract.Requires<InvalidOperationException>( this.IsInExceptionBlock );
		...
		public void EmitCalli( CallingConvention unmanagedCallingConvention, Type returnType, Type[] parameterTypes )
		{
			...
			Contract.Requires<ArgumentException>( Contract.ForAll( parameterTypes, item => item != null ) );
		...
		public void EmitCalli( CallingConventions managedCallingConventions, Type returnType, Type[] requiredParameterTypes, Type[] optionalParameterTypes )
		{
			Contract.Requires<InvalidOperationException>( !this.IsEnded );
			Contract.Requires<ArgumentNullException>( returnType != null );
			Contract.Requires<ArgumentNullException>( requiredParameterTypes != null );
			Contract.Requires<ArgumentException>( Contract.ForAll( requiredParameterTypes, item => item != null ) );
			Contract.Requires<ArgumentNullException>( optionalParameterTypes != null );
			...
			Contract.Requires<ArgumentException>( optionalParameterTypes == null || Contract.ForAll( optionalParameterTypes, item => item != null ) );
		...
		{
			Contract.Requires<InvalidOperationException>( !this.IsEnded );
			Contract.Requires<ArgumentNullException>( constrainedTo != null );
		...
		{
			// QSTRING
			this._trace.Write( String.Format( FormatProviders.InvariantCulture, "\"{0:L}\"", value ) );
		}
